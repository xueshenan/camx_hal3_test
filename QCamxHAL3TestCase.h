...
struct YUVFormat
{
    ...
    uint32_t pixelPlaneSize;  ///< Aligned pixel plane size in bytes, calculated once for UBWC formats
...
public:
    ...
    static void DumpFrame(BufferInfo* info, unsigned int frameNum, StreamType dumpType, Implsubformat subformat);
